...
/* Field: Content: Enrolled */
$handler->display->display_options['fields']['classy_enrolled']['id'] = 'classy_enrolled';
$handler->display->display_options['fields']['classy_enrolled']['table'] = 'field_data_classy_enrolled';
$handler->display->display_options['fields']['classy_enrolled']['field'] = 'classy_enrolled';
$handler->display->display_options['fields']['classy_enrolled']['alter']['alter_text'] = 0;
$handler->display->display_options['fields']['classy_enrolled']['alter']['make_link'] = 0;
$handler->display->display_options['fields']['classy_enrolled']['alter']['absolute'] = 0;
$handler->display->display_options['fields']['classy_enrolled']['alter']['external'] = 0;
$handler->display->display_options['fields']['classy_enrolled']['alter']['replace_spaces'] = 0;
$handler->display->display_options['fields']['classy_enrolled']['alter']['trim_whitespace'] = 0;
$handler->display->display_options['fields']['classy_enrolled']['alter']['nl2br'] = 0;
$handler->display->display_options['fields']['classy_enrolled']['alter']['word_boundary'] = 1;
$handler->display->display_options['fields']['classy_enrolled']['alter']['ellipsis'] = 1;
$handler->display->display_options['fields']['classy_enrolled']['alter']['more_link'] = 0;
$handler->display->display_options['fields']['classy_enrolled']['alter']['strip_tags'] = 0;
$handler->display->display_options['fields']['classy_enrolled']['alter']['trim'] = 0;
$handler->display->display_options['fields']['classy_enrolled']['alter']['html'] = 0;
$handler->display->display_options['fields']['classy_enrolled']['element_label_colon'] = 1;
$handler->display->display_options['fields']['classy_enrolled']['element_default_classes'] = 1;
$handler->display->display_options['fields']['classy_enrolled']['hide_empty'] = 0;
$handler->display->display_options['fields']['classy_enrolled']['empty_zero'] = 0;
$handler->display->display_options['fields']['classy_enrolled']['hide_alter_empty'] = 1;
$handler->display->display_options['fields']['classy_enrolled']['field_api_classes'] = 0;
/* Field: Content: Nid */
...
/* Display: By Course */
$handler = $view->new_display('block', 'By Course', 'by_course');
$handler->display->display_options['display_description'] = 'Block to provide classes, given a Course nid argument';
$handler->display->display_options['defaults']['style_plugin'] = FALSE;
$handler->display->display_options['style_plugin'] = 'table';
$handler->display->display_options['style_options']['columns'] = array(
  'title_1' => 'title_1',
...
$handler->display->display_options['arguments']['nid']['relationship'] = 'classy_course_id_target_id';
...
$handler = $view->new_display('block', 'Class Information', 'information');
$handler->display->display_options['defaults']['title'] = FALSE;
$handler->display->display_options['display_description'] = 'Provides information about a class, given nid';
