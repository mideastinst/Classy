...
/* Display: Class Page */
$handler = $view->new_display('page', 'Class Page', 'classlist');
...
$handler->display->display_options['empty']['area']['field'] = 'area';
$handler->display->display_options['empty']['area']['empty'] = FALSE;
$handler->display->display_options['empty']['area']['content'] = 'You are are not registered for and have not completed any classes.';
$handler->display->display_options['empty']['area']['format'] = 'plain_text';
$handler->display->display_options['empty']['area']['tokenize'] = 0;
$handler->display->display_options['defaults']['fields'] = FALSE;
/* Field: Content: Year */
...
$handler->display->display_options['fields']['title_1']['relationship'] = 'class_id';
